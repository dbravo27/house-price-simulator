...
def calculate_estimate(request):
    if request.method == 'POST':
        ...
        # Calculate the estimated property cost (replace with your logic)
        ...
        values = [
            [name, last_name, email, phone_number, city, neighborhood, square_meters, bedrooms, bathrooms, estimated_cost]
        ]
        body = {
            'values': values
        }
